...
async function main() {
  ...
  // await backgroundLogoElement.setPrice(ethers.utils.parseEther('0.02'));
  // await emoticonLogoElement.toggleMint(ethers.utils.parseEther('0.02'));
  await textLogoElement.setPrice(ethers.utils.parseEther('0.02'));
  // await logos.toggleMint(ethers.utils.parseEther('0.02'));
}

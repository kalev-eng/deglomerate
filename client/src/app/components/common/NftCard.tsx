      ...
      >
        ...
        <CardContent sx={{ flexGrow: 1 }}>
          ...
          <Typography css={[AppStyles.txt, NftCardStyles.numMinted]}>
            {props.minted !== 0 ? props.minted : '-'} / {props.supply !== null ? props.supply : 'infinite'} minted
          </Typography>
